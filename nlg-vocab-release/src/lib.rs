...
fn register_tagged(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_feature_added(engine: &mut Engine) -> Result<(), NlgError> {
    // Low: terse.
    engine.register_template_at(
...
fn register_breaking_change(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_bugfix(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_security_fix(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_deprecation(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_dependency_update(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_contributor_summary(engine: &mut Engine) -> Result<(), NlgError> {
    // Low: bare count.
    engine.register_template_at(
...
fn register_stats(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_summary(engine: &mut Engine) -> Result<(), NlgError> {
