//! Git/VCS activity vocabulary for the `nlg` engine.
//!
...
fn register_commit(engine: &mut Engine) -> Result<(), NlgError> {
...
fn register_pr_opened(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.pr_opened",
...
fn register_pr_merged(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.pr_merged",
...
fn register_pr_closed(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.pr_closed",
...
fn register_issue_opened(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.issue_opened",
...
fn register_issue_closed(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.issue_closed",
...
fn register_review_approved(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.review_approved",
...
fn register_review_changes_requested(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
...
fn register_release(engine: &mut Engine) -> Result<(), NlgError> {
    engine.register_template(
        "git.release",
